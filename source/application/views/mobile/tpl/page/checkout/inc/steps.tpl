[{block name="checkout_steps_main"}]
    <ul class="checkoutSteps [{ if $active == 5}] lastStep[{/if}]">
        ...
        [{block name="checkout_steps_laststep"}]
            [{if $active == 5}]
                <li class="step5 active">
                    <span class="stepId">05</span>
                    <span class="stepName">[{ oxmultilang ident="READY" }]</span>
                </li>
            [{else}]
                <li class="step5">
                    <span class="stepId last">[{ oxmultilang ident="OK" }]</span>
                </li>
            [{/if}]
        [{/block}]
    </ul>
