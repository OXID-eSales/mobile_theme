                        ...
                        <div class="title clear">
                            ...
                            <div class="editButtons">
                                [{ if $blEdit }]
                                    ...
                                    <button class="textButton" type="submit" name="deleteList" value="1">[{ oxmultilang ident="PAGE_RECOMMENDATIONS_LIST_REMOVE" }]</button> | <button class="textButton" type="submit" name="editList">[{ oxmultilang ident="EDIT" }]</button>
                                    </form>
                                [{/if}]
                            </div>
                        </div>
