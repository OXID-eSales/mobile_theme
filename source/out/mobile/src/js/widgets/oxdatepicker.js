 ...
 * @description  oxDatePicker displays date fields or 1 field depending on browser compatibility to understand input date type.
 * Also it executes events for custom datepicker.
 * Widget must be used together Modernizr.
 *
 */
( function( $ ) {
