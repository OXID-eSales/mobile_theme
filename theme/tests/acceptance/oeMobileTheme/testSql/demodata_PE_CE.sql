...
REPLACE INTO `oxconfig` (`OXID`, `OXSHOPID`,   `OXVARNAME`,                     `OXVARTYPE`, `OXVARVALUE`) VALUES
                       ...
                       ('ac17', 'oxbaseshop', 'bl_perfLoadAttributes',         'bool',       0x7900fdf51e),
...
UPDATE `oxshops` SET `OXPRODUCTIVE` = 1, `OXINFOEMAIL` = 'testuser@oxid-esales.dev', `OXORDEREMAIL` = 'testuser@oxid-esales.dev', `OXOWNEREMAIL` = 'testuser@oxid-esales.dev', `OXSMTP` = 'localhost', `OXDEFCAT` = '' WHERE `OXID` = 'oxbaseshop';
