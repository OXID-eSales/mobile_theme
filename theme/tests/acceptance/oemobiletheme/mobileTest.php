...
class Acceptance_oeMobileTheme_mobileTest extends oxTestCase
{
    ...
    public function testSecondStepNotLoginUser()
    {
        ...
        $this->assertElementPresent("//input[@value='Login']");
  ...
  */
    ...
    public function testFrontendPersParamSaveBasketMobile()
    {
        ...
        // Not like with Credit card.
        $aPaymentParams = array("oxsort" => 3);
        $this->callShopSC("oxPayment", "save", "oxidcashondel", $aPaymentParams, 1);
