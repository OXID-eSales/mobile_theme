...
[{ oxmultilang ident="PLUS_VAT" }] [{ $key }][{ oxmultilang ident="SHIPPING_VAT2" }] [{ $VATitem }] [{ $currency->name}]
[{/foreach}]
[{/block}]
...
[{ if $basket->getTsProtectionCosts() }]
    [{ oxmultilang ident="PLUS_VAT" }] [{ $basket->getTsProtectionVatPercent()}][{ oxmultilang ident="SHIPPING_VAT2" }] [{ $basket->getTsProtectionVat() }] [{ $currency->name}]
