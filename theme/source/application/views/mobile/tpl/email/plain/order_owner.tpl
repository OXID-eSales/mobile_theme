...
[{ oxmultilang ident="PLUS_VAT" }] [{ $key }][{ oxmultilang ident="AMOUNT" }] [{ $VATitem }] [{ $currency->name}]
[{/foreach}]
[{/block}]
...
[{if $basket->getDelCostNet() }]
    ...
    [{if $basket->getDelCostVat() }] [{ oxmultilang ident="BASKET_TOTAL_PLUS_PROPORTIONAL_VAT" }] [{else}] [{ oxmultilang ident="PLUS_VAT" }] [{ $basket->getDelCostVatPercent() }][{ oxmultilang ident="AMOUNT" }][{/if}] [{ $basket->getDelCostVat() }] [{ $currency->sign}]
...
[{ if $basket->getPayCostNet() }]
    ...
    [{ if $basket->getPayCostVat() }]
        [{if $basket->isProportionalCalculationOn() }] [{ oxmultilang ident="BASKET_TOTAL_PLUS_PROPORTIONAL_VAT" }][{else}] [{ oxmultilang ident="PLUS_VAT" }] [{ $basket->getPayCostVatPercent() }][{ oxmultilang ident="AMOUNT" }][{/if}] [{ $basket->getPayCostVat() }] [{ $currency->sign}]
    [{/if}]
...
[{ if $basket->getTsProtectionCosts() }]
    [{ oxmultilang ident="PLUS_VAT" }] [{ $basket->getTsProtectionVatPercent()}][{ oxmultilang ident="AMOUNT" }] [{ $basket->getTsProtectionVat() }] [{ $currency->name}]
    [{ if $basket->getTsProtectionVat() }]
        [{if $basket->isProportionalCalculationOn() }][{ oxmultilang ident="BASKET_TOTAL_PLUS_PROPORTIONAL_VAT" }][{else}] [{ oxmultilang ident="PLUS_VAT" }] [{ $basket->getTsProtectionVatPercent() }][{ oxmultilang ident="AMOUNT" }][{/if}]
    [{/if}]
[{/if}]
[{/block}]
...
[{ if $oViewConf->getShowGiftWrapping() }]
    [{if $basket->getGiftCardCostNet() }]
        ...
        [{if $basket->getGiftCardCostVat() }]
            [{if $basket->isProportionalCalculationOn() }][{ oxmultilang ident="BASKET_TOTAL_PLUS_PROPORTIONAL_VAT" }][{else}] [{ oxmultilang ident="PLUS_VAT" }] [{ $basket->getGiftCardCostVatPercent() }][{ oxmultilang ident="AMOUNT" }][{/if}] [{ $basket->getGiftCardCostVat() }] [{ $currency->sign}]
        [{/if}]
...
[{if $payment->oxuserpayments__oxpaymentsid->value != "oxempty"}][{ oxmultilang ident="SHIPPING_CARRIER" }] [{ $order->oDelSet->oxdeliveryset__oxtitle->getRawValue() }]
[{/if}]
[{/block}]
