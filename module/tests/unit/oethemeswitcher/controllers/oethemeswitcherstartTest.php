...
/**
 * Tests for oeThemeSwitcherStart class
 */
class Unit_oeThemeSwitcher_Controllers_oeThemeSwitcherStartTest extends OxidTestCase
{
    /**
     * Overloads oxConfig
     */
    ...
    {
        $oStart = new oeThemeSwitcherStart();
        $sViewId = $oStart->getViewId();
